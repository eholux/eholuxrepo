"""
URL configuration for eholux project.
...
urlpatterns = [
    ...
    path('prodavnica/', include('shop.urls')),
    path('blogovi/', include('blog.urls')),
...
if settings.DEBUG:
    ...
    # No need to explicitly serve from STATIC_ROOT in development
